...
const platformLogos = {
    ...
    pinterest: `
        <svg viewBox="0 0 24 24" aria-hidden="true">
            <path
                fill="currentColor"
                d="M12 0a12 12 0 0 0-4.37 23.17
    ...
    github: `
        <svg viewBox="0 0 24 24" aria-hidden="true">
            <path
                fill="currentColor"
                d="M12 .3a12 12 0 0 0-3.79 23.39
...
function installProjectScrollStyles() {
    ...
    style.textContent = `
        ...
        .project-card img.project-landscape-image {
...
/* =========================================================
   FORCE PAGE TOP ONLY WHEN INITIALIZING
========================================================= */
...
/* =========================================================
   PROJECT IMAGE SCROLL PREPARATION
========================================================= */
...
function prepareProjectImage(
    ...
    */
    ...
    Keep normal square crop because
    vertical scrolling is unnecessary.
    */
    ...
    */
    ...
    function calculateScroll() {
        ...
        */
        ...
        /*
        Image is displayed at card width.
        Calculate displayed image height
        ...
        */
        ...
        /*
        About 18 pixels per second.

        Minimum 12 sec.
        Maximum 55 sec.

        This makes long website screenshots
        move very slowly.
        */
...
function renderProjects() {
    ...
    /*
    Prevent duplicate project sections.
    */
    ...
    document
        ...
        .forEach(
            ...
            button => {
                ...
                /*
                Contact form elements must never
                become navigation controls.
                */
...
function initializeForm() {
    ...
    /*
    Make sure form cannot navigate
    browser to Apps Script page.
    */
    ...
    async function submitPortfolioForm(
        ...
        */
        ...
        try {
            ...
            /*
            Keep user exactly at contact form.
            Never jump to header.
            */
    ...
    /*
    Capture phase prevents another
    submit listener from taking over.
    */
...
function initializeReveal() {
    ...
    /*
    IMPORTANT:
    No animate-ready is added here.

    This protects site from the old
    black/blank-screen problem.
    */
...
function initializeWebsite() {
    ...
    /*
    Install only the required project
    scroll styling.
    */
...
/* =========================================================
   ...
   IMPORTANT:
   এখানে scrollTo(0,0) নেই।
   তাই SEND করার পরে header-এ jump করবে না।
========================================================= */
